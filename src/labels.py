...
def to_clean_demo_label(binary_label: int) -> str:
    """
    Chuyển đổi nhãn nhị phân sang chuỗi nhãn đồng nghĩa ngẫu nhiên.
    Sử dụng cho các ví dụ minh họa từ Round 2 trở đi (từ pool sạch D_clean).
    
    1. Chuyển đổi binary_label về kiểu số nguyên (int).
    2. Nếu label = 0: Trả về một nhãn ngẫu nhiên trong REAL_SYNONYM_LABELS.
    3. Nếu label = 1: Trả về một nhãn ngẫu nhiên trong FAKE_SYNONYM_LABELS.
    """
...
# ============================================================
# LLM Output Parsing (parse cả tiếng Anh "Real"/"Fake" và tiếng Việt "Thật"/"Giả")
# ============================================================
...
def parse_llm_label(
    ...
    Hỗ trợ cả nhãn tiếng Anh (Real/Fake) và tiếng Việt (Thật/Giả).
