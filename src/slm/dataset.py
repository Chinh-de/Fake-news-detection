...
from src.utils import clean_text_for_slm, clean_text_transformer
...
def load_data_from_csv(
    ...
    def load_csv_file(filepath, text_col):
        ...
        try:
            ...
            texts = [clean_text_for_slm(clean_text_transformer(t)) for t in df[text_col].astype(str).tolist()]
